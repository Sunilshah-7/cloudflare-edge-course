...
1. **Cloudflare**: [Request Metrics (CF Object)](https://developers.cloudflare.com/workers/runtime-apis/request/#incomingrequestcfproperties) (~5 min)
2. **Cloudflare**: [Performance Best Practices](https://developers.cloudflare.com/fundamentals/performance/) (~5 min)
