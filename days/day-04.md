...
1. **Cloudflare**: [Request Object](https://developers.cloudflare.com/workers/runtime-apis/request/) (~5 min)
2. **Cloudflare**: [The cf Object](https://developers.cloudflare.com/workers/runtime-apis/request/#incomingrequestcfproperties) — geo, device, TLS info (~3 min)
