/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e735806f2baf0f3de5f6a16365ceb9b2)
// Runtime types generated with workerd@1.20260617.1 2026-06-21 nodejs_compat
interface __BaseEnv_Env {
	SESSION_SECRET: "local-development-only-change-with-wrangler-secret";
	NOTEBOOK: DurableObjectNamespace<import("./src/index").NotebookDocument>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NotebookDocument";
	}
